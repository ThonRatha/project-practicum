                        ...
                        <div class="col-lg-5 col-md-4 p-0">
                            <div class="room-card-img">
                                <a href="room-details.html">
                                    <img src="{{ asset('frontend/assets/img/room/room-1.jpg') }}" alt="Images">
                                </a>
                            </div>
                        </div>
                ...
                <div class="room-card-two">
                    <div class="row align-items-center">
                        <div class="col-lg-5 col-md-4 p-0">
                            <div class="room-card-img">
                                <a href="room-details.html">
                                    <img src="{{ asset('frontend/assets/img/room/room-4.jpg') }}" alt="Images">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-7 col-md-8 p-0">
                            <div class="room-card-content">
                                <h3>
                                    <a href="room-details.html">Queen Room</a>
                                </h3>
                                <span>400 / Per Night </span>
                                <div class="rating">
                                    <i class='bx bxs-star'></i>
                ...
                <div class="room-card-two">
                    <div class="row align-items-center">
                        <div class="col-lg-5 col-md-4 p-0">
                            <div class="room-card-img">
                                <a href="room-details.html">
                                    <img src="{{ asset('frontend/assets/img/room/room-3.jpg') }}" alt="Images">
                                </a>
                            </div>
                        </div>
                ...
                <div class="room-card-two">
                    <div class="row align-items-center">
                        <div class="col-lg-5 col-md-4 p-0">
                            <div class="room-card-img">
                                <a href="room-details.html">
                                    <img src="{{ asset('frontend/assets/img/room/room-2.jpg') }}" alt="Images">
                                </a>
                            </div>
                        </div>
